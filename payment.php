...
<div class="jumbotron" style="background: url('images/2.jpg') no-repeat;background-size: cover;height: 300px;"></div>	
 ...
 <div class="container">
<div class="card">
     <div class="card-body" style="background-color:#F85A16;color:black;">
         <div class="row">
             <div class="col-md-1">
    <a href="admin-panel.php" class="btn btn-light ">Go Back</a>
             </div>
             <div class="col-md-3"><h3>Payment Archive</h3></div>
             <div class="col-md-8">
...
<input type="submit" class="btn btn-primary" name="pay_submit" value="Archive">
     </div>
    </div>
    </div>
